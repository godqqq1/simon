...
/* Sets stack size of next task created

	This function sets the stack size of the next task created using OSCreateTask. 
	
	Pre: stackSize = Size of stack in 32-bit longs
	Post: All subsequent created tasks will have stacks of size stackSize.
