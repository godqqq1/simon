/*
  ...
  This code reads value on pin A0
  and sends result on 4-20mA current loop

  The transmitted range is set to [0..100]
  same as in MikroElektronika example  
 */
...
const int DAC_4mA  = 801;
const int DAC_20mA = 3994;
